...
return[
    ...
    'token'          => env('token',''),
    'appid'          => env('appid','wx426b3015555a46be'),
    'appsecret'      => env('appsecret','7813490da6f1265e4901ffb80afaa36f'),
    'encodingaeskey' => env('encodingaeskey',''),

    //配置商户支付参数
    'mch_id'         => env('mch_id','1900009851'),
    'mch_key'        => env('mch_key','8934e7d15453e97507ef794cf7b0519d'),

    //证书路径,注意应该填写绝对路径（仅退款、撤销订单时需要，可登录商户平台下载，
    //API证书下载地址：https://pay.weixin.qq.com/index.php/account/api_cert，下载之前需要安装商户操作证书）
    'ssl_key'        =>  storage_path('pay/wechat/apiclient_cert.pem'),
    'ssl_cer'        =>  storage_path('pay/wechat/apiclient_key.pem'),
    ...
    //开启错误上报。上报等级，0.关闭上报; 1.仅错误出错上报; 2.全量上报
